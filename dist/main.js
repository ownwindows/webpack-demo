                ...
                var ar = Dt( { "&amp;": "&", "&lt;": "<", "&gt;": ">", "&quot;": '"', "&#39;": "'" } ),
                    cr = function n( t ) {
                        var r, e = ( t = null == t ? ot : cr.defaults( ot.Object(), t, cr.pick( ot, Yn ) ) ).Array,
                            un = t.Date, xn = t.Error, jn = t.Function, An = t.Math, kn = t.Object, On = t.RegExp,
                            In = t.String, Rn = t.TypeError, En = e.prototype, zn = jn.prototype, Sn = kn.prototype,
                            ...
                            Vn = tr( kn.getPrototypeOf, kn ), Hn = kn.create, tt = Sn.propertyIsEnumerable,
                            ut = En.splice, it = Nn ? Nn.isConcatSpreadable : u, ft = Nn ? Nn.iterator : u,
                            at = Nn ? Nn.toStringTag : u, lt = function () {
                                try {
                            ...
                            gr = tr( kn.keys, kn ), yr = An.max, dr = An.min, br = un.now, wr = t.parseInt,
                            mr = An.random, xr = En.reverse, jr = ci( t, "DataView" ), Ar = ci( t, "Map" ),
                            kr = ci( t, "Promise" ), Or = ci( t, "Set" ), Ir = ci( t, "WeakMap" ),
                            Rr = ci( kn, "create" ), Er = Ir && new Ir, zr = {}, Sr = $i( jr ), Lr = $i( Ar ),
                            Wr = $i( kr ), Cr = $i( Or ), Tr = $i( Ir ), Ur = Nn ? Nn.prototype : u,
